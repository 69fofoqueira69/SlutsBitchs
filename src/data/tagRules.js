...
const measurementRules = {
  ...
  waist: [
    ...
    { min: 30.1, max: 80, tag: 'Atlética', range: '30.1–80', emoji: '🏃‍♀️' },
  ...
  thighs: [
    ...
    { min: 20.5, max: 53.6, tag: 'Atlética', range: '20.5–53.6', emoji: '🏃‍♀️' },
  ...
  chest: [
    ...
    { min: 10.3, max: 34, tag: 'Pequeno', range: '10.3–34', emoji: '🍒' },
    { min: 34.1, max: 88.9, tag: 'Médio', range: '34.1–88.9', emoji: '🍈' },
    { min: 89, max: 246, tag: 'Volumoso', range: '89–246', emoji: '🍉' },
    { min: 246.1, max: 670, tag: 'Avantajado', range: '246.1–670', emoji: '🚀' }
  ]
};
