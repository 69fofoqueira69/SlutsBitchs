...
- `src/Componentes/CriadorPerfil.js`: formulário administrativo de criação com campos inicialmente vazios, classificação automática de medidas por faixas e validação de campos obrigatórios por gênero.
