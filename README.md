...
- `src/Paginas/Perfil.js` + `src/Componentes/Detalhes.js`: página de perfil em layout wireframe de tela inteira (botões de ação no topo, painel textual à esquerda e imagem em destaque à direita).
