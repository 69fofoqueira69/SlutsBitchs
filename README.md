...
- `src/Componentes/CriadorPerfil.js`: formulário administrativo com ações de criar/editar perfil, configuração embutida do GitHub, classificação automática de medidas por faixas e exibição de caminhos de mídia apenas no modo de edição.
